...
/*
  ...
  Controller description: User Registration, Authentication, User Info, User Meta, FB & Google Login, BuddyPress xProfile Fields methods
  Controller Author: Ali Qureshi, Vignesh Sundar
...
public function g_connect() {
	...
	if (!$json_api->query->id_token) {
		$json_api->error("You must include a 'id_token' variable. Get the valid id_token for this app from Google API.");
	} else {
